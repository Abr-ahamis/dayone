...
public abstract class Hilt_DayOneAlarmReceiver extends BroadcastReceiver {
  ...
  protected void inject(Context context) {
    if (!injected) {
      synchronized (injectedLock) {
        if (!injected) {
          ((DayOneAlarmReceiver_GeneratedInjector) BroadcastReceiverComponentManager.generatedComponent(context)).injectDayOneAlarmReceiver(UnsafeCasts.<DayOneAlarmReceiver>unsafeCast(this));
          injected = true;
        }
      }
    }
